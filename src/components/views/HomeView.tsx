...
export const HomeView: React.FC<HomeViewProps> = ({ onSelectProduct, onBookProduct }) => {
  ...
  return (
    <div className="space-y-8 sm:space-y-12 pb-16">
      ...
      {/* 1. HERO SECTION (Solid Colors & Mobile Responsive) */}
      <section className="relative min-h-[420px] bg-slate-900 text-white rounded-3xl overflow-hidden shadow-xl border border-slate-800 flex items-center">
        ...
        <div className="relative z-10 max-w-3xl px-6 sm:px-12 py-10 space-y-6">
          ...
          <h1 className="text-2xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight leading-tight">
            Sewa Motor Cepat, <br className="hidden sm:inline" />
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-1">
            <button
              ...
              className="bg-purple-600 hover:bg-purple-700 text-white font-bold px-6 py-3 rounded-xl shadow-xs transition-all flex items-center justify-center gap-2 text-xs active:scale-95"
            >
            ...
            <button
              onClick={() => setActiveView('katalog')}
              className="bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 font-semibold px-5 py-3 rounded-xl transition-all text-xs flex items-center justify-center gap-2 active:scale-95"
            >
            ...
            <div className="space-y-2 pt-1 text-xs">
              <div className="flex items-start gap-3 p-3.5 bg-slate-50 rounded-2xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-[11px] leading-relaxed">Tunjukkan QR Code dari HP Anda kepada operator lapangan untuk verifikasi unit langsung.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 bg-slate-50 rounded-2xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-[11px] leading-relaxed">Data NIK & foto identitas Anda dienkripsi dan memiliki retensi auto-delete permanen 72 jam.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-slate-900 tracking-tight">Katalog Motor Populer</h2>
            <p className="text-slate-500 text-xs mt-0.5">Pilih dari armada motor matic & sport pilihan.</p>
          </div>
          <button
            onClick={() => setActiveView('katalog')}
            className="text-purple-600 hover:text-purple-700 text-xs font-bold flex items-center gap-1 shrink-0"
          >
            ...
            >
              ...
              <div className="p-4 pt-0 border-t border-slate-100 mt-3 flex items-center justify-between">
                ...
                <button
                  ...
                  className="bg-purple-600 hover:bg-purple-700 active:scale-95 text-white px-4 py-2 rounded-xl text-xs font-bold transition-all"
                >
                  Sewa
                </button>
              </div>
