...
import { 
  Bike, Home, Store, History, User, LogOut, Menu, X, ChevronRight 
} from 'lucide-react';
...
export const SidebarCustomer: React.FC = () => {
  ...
  const navItems = [
    ...
    { id: 'katalog', label: 'Katalog Motor', icon: Store },
  ...
  return (
    <>
      ...
      `}>
        <div>
          {/* Brand Header */}
          <div className="hidden lg:flex items-center gap-2.5 px-2 mb-6">
            <div 
              onClick={() => handleNavClick('home')} 
